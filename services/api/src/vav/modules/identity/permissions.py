...
DATA_GOVERNANCE_PERMISSIONS = {
    ...
    "data.assets.manage",
    "data.contracts.read",
    "data.contracts.manage",
    "data.contracts.activate",
    "data.lineage.read",
    "data.lineage.manage",
    "data.lineage.verify",
    "data.events.read",
    ...
    "data.events.consume",
    "data.events.replay",
    "data.dead_letters.read",
    "data.dead_letters.manage",
    "data.quality.read",
    "data.quality.evaluate",
    "data.reconciliations.read",
    "data.reconciliations.run",
    "data.reconciliations.manage",
    "data.backfills.read",
    "data.backfills.run",
    "data.backfills.manage",
    "data.backfills.approve",
    "data.repairs.read",
    "data.repairs.execute",
    "data.repairs.approve",
    "data.projections.read",
    "data.projections.rebuild",
    "data.erasures.read",
    "data.erasures.plan",
    "data.erasures.execute",
    "data.erasures.certify",
    "data.certifications.read",
    "data.certifications.evaluate",
...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "data_steward": DATA_GOVERNANCE_PERMISSIONS
    - {
        "data.backfills.approve",
        "data.repairs.approve",
        "data.erasures.execute",
