...
TEMPLATE_CODES = (
    ...
    ("membership-activated", "membership", "transactional"),
    ("membership-renewed", "membership", "transactional"),
    ("membership-payment-failed", "membership", "transactional"),
    ("membership-grace-period", "membership", "transactional"),
    ("membership-cancel-scheduled", "membership", "transactional"),
    ("membership-expired", "membership", "transactional"),
    ("membership-plan-changed", "membership", "transactional"),
    ("membership-quota-warning", "membership", "service"),
